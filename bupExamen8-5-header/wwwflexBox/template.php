...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="./opmaak/template.css?v6">
</head>
 ...
 <main>
  <form action="#" type="POST" enctype="application/x-www-form-urlencoded"></form>
...
<!-- -->
 <nav>
     ...
     <li class="nav__knop">   <span                 class="fas hamburger_button"> &#9776;                      </span>
         <span class="fas sluitKnop verbergen"> &#215;                                                            </span>
     </li>
     <li class="nav__item"> <a href= "#"          class="nav__link"> <span class="nav__text"> Home           </span>  </a>  </li>
